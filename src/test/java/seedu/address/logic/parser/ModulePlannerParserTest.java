...
public class ModulePlannerParserTest {
    ...
    @Test
    public void parseCommand_commitStudyPlanEdit() throws Exception {
        CommitStudyPlanEditCommand command = new CommitStudyPlanEditCommand(VALID_COMMIT_MESSAGE);
        assertEquals(parser.parseCommand(CommitStudyPlanEditCommand.COMMAND_WORD
                + " " + VALID_COMMIT_MESSAGE), command);
    }
